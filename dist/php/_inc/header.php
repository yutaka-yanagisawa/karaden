<header class="header" id="header" data-scroll-header><a class="header-logo" href="<?=$path?>"></a>
  <div id="nav-toggle">
  ...
  <div id="global-nav">
    <div class="global-nav-wrap">
      <ul class="global-nav-list">
        ...
        <li class="global-nav-list-item global-nav-list-item06"><a class="global-nav-list-item-link" href="<?=$path?>faq/">よくある質問</a></li>
