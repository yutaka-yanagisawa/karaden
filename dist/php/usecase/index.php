  ...
  <body id="usecase">
    ...
    <div class="wrapper">
      ...
      <section class="section-grey">
        <div class="inner">
          <h2 class="section-heading">利用用途</h2>
      ...
      <section class="section-blue-left">
        <div class="inner">
          <h2 class="section-heading">業界別導入例 </h2>
          <div class="scene-example-link-nav-block">
            <div class="item"> <a href="#example01" data-scroll>クレジットカード</a></div>
            <div class="item"> <a href="#example02" data-scroll>銀行・消費者ローン</a></div>
            <div class="item"> <a href="#example03" data-scroll>電気・ガス・水道・ISP</a></div>
            <div class="item"> <a href="#example04" data-scroll>不動産</a></div>
            <div class="item"> <a href="#example05" data-scroll>生保・損保会社</a></div>
            <div class="item"> <a href="#example06" data-scroll>引越・物流</a></div>
            <div class="item"> <a href="#example07" data-scroll>美容・エステ・スポーツクラブ</a></div>
            <div class="item"> <a href="#example08" data-scroll>派遣・人材紹介・採用</a></div>
            <div class="item"> <a href="#example09" data-scroll>鉄道・船舶・航空</a></div>
            <div class="item"> <a href="#example10" data-scroll>コールセンター</a></div>
            <div class="item"> <a href="#example11" data-scroll>自治体</a></div>
          </div>
