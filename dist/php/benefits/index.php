  ...
  <body id="benefits">
    ...
    <div class="wrapper">
      ...
      <section class="section-grey">
        <div class="inner">
          <h2 class="section-heading section-heading-sp2line pcmt20 spmt20">顧客とのコミュニケーションの課題を解決</h2>
          <p class="section-lead pcmt10 spmt10">SMSは「メール・電話はなかなか連絡が取れない」「郵便は反応がわからない」「メールは開封されない」などの顧客とのコミュニケーション課題を解決します。</p>
        </div>
      ...
      <section class="section-blue-left">
        <div class="inner">
          <div class="merit-list-block">
            <div class="item">
              <div class="text-box">
                <h3 class="title">誰にでも届く</h3>
                <p class="text">通話ができるほとんどの携帯電話でSMSの受信が可能です。<br class="pc">携帯電話に標準搭載されている機能なので、メッセージを受け取るのに<br class="pc">お客様側で何か準備していただく必要はありません。<br class="pc">携帯電話を買ったその日から送信できます。</p>
            ...
            <div class="item">
              <div class="text-box">
                <h3 class="title">着眼率が高い</h3>
                <p class="text">日常的に使用する携帯電話宛てに送信でき、受信すると画面上に新着通知があるため、目につきやすく、開封率が非常に高いことが特徴です。</p>
                <p class="text-comment">受信者の98%以上が届いたSMSを読んでいる*</p>
            ...
            <div class="item">
              <div class="text-box">
                <h3 class="title">反応率が高い</h3>
                <p class="text">ユーザーの操作はタップだけ。URLをタップするとすぐにWebページへ遷移し<br class="pc">ます。また、電話番号をタップするとすぐに電話をかけることができます。</p>
                <div class="text-comment">SMSを送った対象の85％から折り返し電話が<br class="pc">あった*</div>
      ...
      <section class="section-grey-right">
        <div class="inner">
          <h2 class="section-heading section-heading-sp2line">お客様とのコンタクト手段の<br class="sp">比較</h2>
          <table class="contact-compare-table pcmt100 spmt100">
      ...
      <section class="section-blue-left">
        <div class="inner">
          <h2 class="section-heading section-heading-sp2line">SMS送信サービス<br class="sp">「空電プッシュ」導入効果</h2>
          <div class="result-block pcmt100 spmt100">
            <div class="item">
